...
public class WindowUtil {
    ...
    public static boolean setWidth(View view, int designedWidthResId) {
        float designedWidth = AppApplication.getAppContext().getResources().getDimension(designedWidthResId);
    ...
    public static boolean setHeight(View view, int designedHeightResId) {
        if (view == null)
            return false;
        float designedHeight = AppApplication.getAppContext().getResources().getDimension(designedHeightResId);
        LayoutParams params = null;
        if (view instanceof ViewGroup)
            params = view.getLayoutParams();
        if (params == null)
    ...
    public static boolean setTextSize(TextView view, int designedTextSizeResId) {
        if (view == null)
            return false;
        float designedSize = AppApplication.getAppContext().getResources().getDimension(designedTextSizeResId);
    ...
    public static float getHorizontalScaledDimen(int heightResId) {
        return AppApplication.getAppContext().getResources().getDimension(heightResId) * SCALE_RATIO_HORIZONTAL;
    }
    ...
    public static float getVerticalScaledDimen(int heightResId) {
        return AppApplication.getAppContext().getResources().getDimension(heightResId) * SCALE_RATIO_VERTICAL;
    }
    ...
    public static int getWindowWidth() {
        ...
        dm = AppApplication.getAppContext().getResources().getDisplayMetrics();
        if (dm == null)
            return 0;
    ...
    public static float computeDimen(int resId) {
        return AppApplication.getAppContext().getResources().getDimension(resId);
    }
    ...
    public static boolean isLandscape() {
        return AppApplication.getAppContext().getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE;
    }
    ...
    public static int dip2px(float dip) {
        float f = AppApplication.getAppContext().getResources().getDisplayMetrics().density;
    ...
    public static int getStatusBarHeight() {
        ...
        try {
            ...
            statusBarHeight = AppApplication.getAppContext().getResources().getDimensionPixelSize(x);
    ...
    public static void computeWindowRotation() {
        WindowManager windowManager = (WindowManager) AppApplication.getAppContext().getSystemService(Context.WINDOW_SERVICE);
