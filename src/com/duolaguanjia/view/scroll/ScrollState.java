package com.duolaguanjia.view.scroll;
...
public class ScrollState {
    ...
    public ScrollState() {
        mScroller = new Scroller(AppApplication.getAppContext());
    }

    public ScrollState(Interpolator interpolator) {
        mScroller = new Scroller(AppApplication.getAppContext(), interpolator);
    }
